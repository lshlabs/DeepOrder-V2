...
import type {
  CreateSupportConversationRequest, CreateSupportEventRequest, MarkSupportReadRequest,
  SendSupportMessageRequest, SupportConversationListResponse, SupportConversationResponse,
  SupportEventListResponse, SupportMessageListResponse,
} from "../types/support";

export function apiCreateSupportConversation(
  accessToken: string,
...
export function apiGetCurrentSupportConversation(accessToken: string) {
  return request<SupportConversationResponse | null>("/api/kds/support/conversations/current", {
    headers: createAuthHeaders(accessToken),
  });
}

export function apiGetSupportConversation(accessToken: string, conversationId: string | number) {
  return request<SupportConversationResponse>(`/api/kds/support/conversations/${conversationId}`, {
    headers: createAuthHeaders(accessToken),
  });
}

export function apiListSupportConversations(accessToken: string) {
  return request<SupportConversationListResponse>("/api/kds/support/conversations", {
    headers: createAuthHeaders(accessToken),
  });
}

export function apiSendSupportMessage(
  accessToken: string,
...
export function apiListSupportMessages(
  accessToken: string,
  conversationId: string | number,
...
export function apiCreateSupportEvent(
  accessToken: string,
  conversationId: string | number,
...
export function apiListSupportEvents(accessToken: string, conversationId: string | number) {
  return request<SupportEventListResponse>(`/api/kds/support/conversations/${conversationId}/events`, {
    headers: createAuthHeaders(accessToken),
  });
}

export function apiMarkSupportRead(
  accessToken: string,
  conversationId: string | number,
...
export function apiRequestSupportHandoff(accessToken: string, conversationId: string | number) {
...
export function apiCancelSupportHandoff(accessToken: string, conversationId: string | number) {
...
export function apiAssignSupportConversation(accessToken: string, conversationId: string | number) {
...
export function apiSendSupportAgentMessage(
  accessToken: string,
  conversationId: string | number,
  payload: SendSupportMessageRequest,
) {
...
export function apiCloseSupportConversation(accessToken: string, conversationId: string | number) {
