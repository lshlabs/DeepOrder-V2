...
export function apiGetKdsOrders(accessToken: string) {
  return request<KdsOrdersResponse>("/api/kds/orders", { headers: createAuthHeaders(accessToken) });
}
export function apiUpdateOrderStatus(accessToken: string, orderId: number, status: OrderStatus) {
...
export function apiHideOrder(accessToken: string, orderId: number) {
  return request<HideOrderResponse>(`/api/kds/orders/${orderId}/hide`, {
    method: "PATCH", headers: createAuthHeaders(accessToken),
  });
}
export function apiArchiveCompletedOrders(accessToken: string) {
...
export function apiUpdateOrderItemProgress(accessToken: string, orderItemId: number, payload: UpdateOrderItemProgressRequest) {
...
export function apiUpdateOrderItemOptionProgress(accessToken: string, orderItemId: number, optionIndex: number, payload: UpdateOrderItemProgressRequest) {
