...
export type KdsOrdersResponse = { orders: Order[] };
export type OrderSortDirection = "newest-first" | "oldest-first";
export type OrderLayoutColumn = { orders: Order[]; width: "base" | "wide" | "xwide" };
export type HideOrderResponse = { orderId: number; hidden: boolean };
export type ArchiveCompletedOrdersResponse = { archivedCount: number };
