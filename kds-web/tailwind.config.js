  ...
  theme: {
    extend: {
      colors: {
        ...
        "surface-2": hslVar("--surface-2"),
        "surface-3": hslVar("--surface-3"),
        "border-strong": hslVar("--border-strong"),
        hero: hslVar("--hero"),
        "hero-foreground": hslVar("--hero-foreground"),
        "hero-muted": hslVar("--hero-muted"),
        "primary-soft": hslVar("--primary-soft"),
        "success-soft": hslVar("--success-soft"),
        "warning-soft": hslVar("--warning-soft"),
        "destructive-soft": hslVar("--destructive-soft"),
      ...
      boxShadow: {
        ...
        "floating-elevated": "var(--shadow-floating-elevated)",
      },
      keyframes: {
        "accordion-down": {
          from: {
